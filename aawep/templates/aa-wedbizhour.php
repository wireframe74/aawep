					...
					<div class="tab-container container-fluid tabbed-content-margin">
							...
							<div class="container">
									...
									<div id="tab-wedbizhour" class="tab-pane">
		 									<h2>#WEDBIZHOUR</h2>
											<h4>The latest tweets from #wedbizhour with Christine.</h4>
...
<script async src="//platform.twitter.com/widgets.js" charset="utf-8"></script>
 -->
<a class="twitter-timeline" href="https://twitter.com/hashtag/wedbizhour" data-widget-id="521593303465086976">#wedbizhour Tweets</a>
