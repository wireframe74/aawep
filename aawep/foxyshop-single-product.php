...
<div id="compareNinjaTable_62686">
...
(function() {
	...
	cn.src = ('https:' == document.location.protocol ? 'https://' : 'http://') + 'compareninja.com/API/table/62686?cnurl=' + window.location.href;
...
<?php echo '<a id="fillForm" class="btn btn-lg btn-primary" href="#" role="button">Enrol Online</a>'; ?>
...
<li><a href="#tab-four" data-toggle="tab">Bpay</a></li>
<li><a href="#tab-six" data-toggle="tab">Direct Debit</a></li>
